...
internal sealed class AgentResultComposer
{
        ...
        int crashedCount = 0)
    {
        ...
        var intentLabel = intent switch
        {
            ...
            AgentIntent.SudoersCheck => "Sudoers check",
            AgentIntent.SystemdTimerSocketCheck => "Systemd timer/socket check",
            AgentIntent.MacCheck => "MAC check",
            AgentIntent.BootloaderCheck => "Boot loader check",
