...
2. Agent scanners collect firewall, port, service, SSH daemon configuration, file permissions, interface, route, and connection state from local Linux commands, plus data-source capability status for those commands.
