...
public class QueryParserTests
{
    ...
    [InlineData("is secure boot enabled", AgentIntent.BootloaderCheck)]
    ...
    [InlineData("check sudoers", AgentIntent.SudoersCheck)]
    [InlineData("sudo config", AgentIntent.SudoersCheck)]
    [InlineData("nopasswd sudo", AgentIntent.SudoersCheck)]
    [InlineData("passwordless sudo", AgentIntent.SudoersCheck)]
    [InlineData("check systemd timers", AgentIntent.SystemdTimerSocketCheck)]
    [InlineData("systemd sockets", AgentIntent.SystemdTimerSocketCheck)]
    [InlineData("list timers", AgentIntent.SystemdTimerSocketCheck)]
    [InlineData("socket activation", AgentIntent.SystemdTimerSocketCheck)]
