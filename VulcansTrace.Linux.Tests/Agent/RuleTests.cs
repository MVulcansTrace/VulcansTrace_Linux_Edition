...
public class RuleTests
{
    ...
    [InlineData(typeof(LoopbackExposureRule), "CIS 4.4")]
    [InlineData(typeof(SshNonDefaultPortRule), "CIS 4.8")]
    [InlineData(typeof(WideOpenServicesRule), "CIS 4.4")]
    [InlineData(typeof(DatabasePortExposureRule), "CIS 4.4")]
    ...
    [InlineData(typeof(AslrEnabledRule), "CIS 4.1")]
    [InlineData(typeof(IpForwardingDisabledRule), "CIS 4.1")]
    [InlineData(typeof(IcmpRedirectsDisabledRule), "CIS 4.1")]
    [InlineData(typeof(SourceRoutingDisabledRule), "CIS 4.1")]
    [InlineData(typeof(KernelModuleLoadingRestrictedRule), "CIS 4.1")]
    [InlineData(typeof(SecureBootEnabledRule), "CIS 4.1")]
    [InlineData(typeof(KernelPointerExposureRestrictedRule), "CIS 4.1")]
    ...
    [Theory]
    [InlineData(typeof(SecurityUpdatesAvailableRule), "CIS 7.3")]
    [InlineData(typeof(UnattendedUpgradesEnabledRule), "CIS 7.3")]
