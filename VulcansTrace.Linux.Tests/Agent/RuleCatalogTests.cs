...
public class RuleCatalogTests
{
    ...
    [InlineData("NET-004", "CIS 4.4")]
    [InlineData("PORT-001", "CIS 4.8")]
    [InlineData("PORT-002", "CIS 4.4")]
    [InlineData("PORT-003", "CIS 4.4")]
    ...
    [InlineData("SSH-004", "CIS 4.1")]
    [InlineData("SSH-005", "CIS 5.2")]
    [InlineData("SSH-006", "CIS 6.3")]
    [InlineData("SSH-007", "CIS 4.1")]
    [InlineData("SSH-008", "CIS 4.1")]
    ...
    [InlineData("FSYS-005", "CIS 4.1")]
    [InlineData("KERN-001", "CIS 4.1")]
    [InlineData("KERN-002", "CIS 4.1")]
    [InlineData("KERN-003", "CIS 4.1")]
    [InlineData("KERN-004", "CIS 4.1")]
    [InlineData("KERN-005", "CIS 4.1")]
    [InlineData("KERN-006", "CIS 4.1")]
    [InlineData("KERN-007", "CIS 4.1")]
    ...
    [InlineData("PKG-VULN-001", "CIS 7.3")]
    [InlineData("PKG-VULN-002", "CIS 7.3")]
    [InlineData("CTR-001", "CIS 4.1")]
    [InlineData("CTR-002", "CIS 4.1")]
    [InlineData("CTR-003", "CIS 4.1")]
    [InlineData("CTR-004", "CIS 4.1")]
    [InlineData("CTR-005", "CIS 4.1")]
    [InlineData("K8S-001", "CIS 4.1")]
    [InlineData("K8S-002", "CIS 4.1")]
    [InlineData("K8S-003", "CIS 4.1")]
    [InlineData("K8S-004", "CIS 4.1")]
